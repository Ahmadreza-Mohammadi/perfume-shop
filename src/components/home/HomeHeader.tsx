            ...
            <div className="flex items-center gap-2 md:gap-4">
              ...
              {!user ? (
                <button
                  ...
                  className="group relative px-3 py-2 rounded-xl cursor-pointer bg-gray-50 hover:bg-gray-100 transition-all duration-300 ease-out shadow-sm hover:shadow-md border border-gray-200 hover:border-gray-300 text-gray-700 text-sm sm:text-base"
                >
                  ثبت نام
                </button>
              ) : null}
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              >
                <div className="relative p-1 rounded-2xl bg-gray-50 hover:bg-gray-100 transition-all duration-300 ease-out shadow-sm hover:shadow-md border border-gray-200 hover:border-gray-300">
                  <Image
                    src={profile?.avatarUrl || profileIcon}
                    width={48}
                    height={48}
